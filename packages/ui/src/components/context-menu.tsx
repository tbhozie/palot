...
function ContextMenuItem({
	...
	return (
		<ContextMenuPrimitive.Item
			...
			className={cn(
				"focus:bg-secondary focus:text-secondary-foreground [&:hover]:bg-secondary [&:hover]:text-secondary-foreground [&[data-highlighted]]:bg-secondary [&[data-highlighted]]:text-secondary-foreground data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 dark:data-[variant=destructive]:focus:bg-destructive/20 [&[data-variant=destructive]:hover]:bg-destructive/10 dark:[&[data-variant=destructive]:hover]:bg-destructive/20 [&[data-variant=destructive][data-highlighted]]:bg-destructive/10 dark:[&[data-variant=destructive][data-highlighted]]:bg-destructive/20 data-[variant=destructive]:focus:text-destructive [&[data-variant=destructive]:hover]:text-destructive [&[data-variant=destructive][data-highlighted]]:text-destructive data-[variant=destructive]:*:[svg]:text-destructive focus:*:[svg]:text-secondary-foreground [&:hover]:*:[svg]:text-secondary-foreground [&[data-highlighted]]:*:[svg]:text-secondary-foreground gap-2 rounded-sm px-2 py-1.5 text-sm data-inset:pl-8 [&_svg:not([class*='size-'])]:size-4 group/context-menu-item relative flex cursor-default items-center outline-hidden select-none transition-colors data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
				className,
			)}
			{...props}
		/>
